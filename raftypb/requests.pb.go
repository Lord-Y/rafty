...
func (x *AskNodeIDRequest) GetIsVoter() bool {
	if x != nil {
		return x.IsVoter
	}
	return false
...
func (x *AskNodeIDResponse) GetIsVoter() bool {
	if x != nil {
		return x.IsVoter
	}
	return false
